...
Revision ID: bb524ab75a3d
Revises: ad2cc81faefa
Create Date: 2024-09-08 20:44:24.912938
...
revision: str = 'bb524ab75a3d'
down_revision: Union[str, None] = 'ad2cc81faefa'
...
def upgrade() -> None:
    ...
    sa.Column('user_screen_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['creator_id'], ['TBL_USER.user_id'], ),
